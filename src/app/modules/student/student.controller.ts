...
const myCourses = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: "Student's enrolled courses data fetched successfully",
    data: result,
  });
});
...
const getMyCourseSchedules = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    ...
    success: true,
    message:
      "Student's course schedules(Class Routine) data fetched successfully",
    data: result,
  });
});
...
const myAcademicInfo = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: "My (Student's) Academic Info Data Fetched Successfully",
    data: result,
  });
});
