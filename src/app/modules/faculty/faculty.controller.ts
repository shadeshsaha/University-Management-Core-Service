...
const assignCourses = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: 'Course Assigned In Faculty Successfully',
    data: result,
  });
});
...
const myCourses = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: 'My(Faculty) courses data fetched Successfully!',
    data: result,
  });
});
...
const getMyCourseStudents = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: 'My (Faculty) course students data fetched successfully',
    meta: result.meta,
    data: result.data,
  });
});
